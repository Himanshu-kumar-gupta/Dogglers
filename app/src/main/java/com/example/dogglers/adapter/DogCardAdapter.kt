...
class DogCardAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): DogCardViewHolder {
        ...
        val inflatedLayout = when(layout) {
    ...
    override fun onBindViewHolder(holder: DogCardViewHolder, position: Int) {
        ...
        holder.dogAge.text = resources!!.getString(R.string.dog_age,dataset[position].age)
        holder.dogHobbies.text = resources.getString(R.string.dog_hobbies, dataset[position].hobbies)
